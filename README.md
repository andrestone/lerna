...
- `useWorkspaces`: Enables integration with Yarn Workspaces. The values in the array are the commands in which Lerna will delegate operation to Yarn. `packages` will be overridden by the value from package.json/workspaces.
